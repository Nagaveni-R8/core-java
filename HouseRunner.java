class HouseRunner{
    ...
    public static void main(String housing[]){
		...
		ref2.noOfRooms = 6;
		ref2.noOfFloors = 7;
		ref2.houseName = "Jenu Goodu";
		ref2.areaInSqrt = 2800;
		ref2.noOfMembers = 12 ;
		System.out.println("House BluePrint are");
		...
		ref3.noOfRooms = 2;
		ref3.noOfFloors = 5;
		ref3.houseName = "Pavithra Nilaya";
		ref3.areaInSqrt = 2200;
		ref3.noOfMembers = 4 ;
		System.out.println("House BluePrint are");
		...
		ref8.noOfRooms = 3;
		ref8.noOfFloors = 6;
		ref8.houseName = "Alakananda Nilayam";
		ref8.areaInSqrt = 2300;
		ref8.noOfMembers = 9 ;
		System.out.println("House BluePrint are");
