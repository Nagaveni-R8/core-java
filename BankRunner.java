class BankRunner{
    ...
    public static void main(String banking[]){
		...
		ref.branchName = "Head Office, Treasuary Department";
		ref.ifscCode = "KARB0000001";
		ref.swiftCode = "AAAADDTTUUWW";
		ref.noOfWorker = 8;
		ref.branchManagerName = "Anushree";
		...
		ref3.bankId = 4256787;
		ref3.bankName = "Bank of Baroda";
		ref3.branchName = "Treasury Branch";
		ref3.ifscCode = "BARB07687237";
		ref3.swiftCode = "AAAABBCCDDDD";
		ref3.noOfWorker = 10;
		ref3.branchManagerName = "Sushil";
		...
		System.out.println("Branch Name is " + ref4.branchName);
		...
		ref5.bankId = 376190;
		ref5.bankName = "Union Bank of India";
		ref5.branchName = "Kolkatta";
		ref5.ifscCode = "UTBI0HOA139";
		ref5.swiftCode = "GGGGTTTTWWWW";
		ref5.noOfWorker = 18;
		ref5.branchManagerName = "Aarshika";
	    ...
	    ref6.bankId = 743971;
		ref6.bankName = "HDFC Bank";
		ref6.branchName = "Mumbai";
		ref6.ifscCode = "HDFC0999999";
		ref6.swiftCode = "KKKKUUPPFFFF";
		ref6.noOfWorker = 20;
		ref6.branchManagerName = "Arjun";
		...
		ref7.branchName = "Treasury Branch";
		ref7.ifscCode = "SBIN0004343";
		ref7.swiftCode = "AAAAGGGGWWDD";
		ref7.noOfWorker = 16;
		ref7.branchManagerName = "Sushanth";
		...
		ref8.bankId = 7231649;
		ref8.bankName = "Syndicate Bank";
		ref8.branchName = "Mumbai";
		ref8.ifscCode = "SYNB000RTGS";
		ref8.swiftCode = "AABBTTHHKKLL";
		ref8.noOfWorker = 13;
		ref8.branchManagerName = "Saraswathi";
		
		System.out.println("Bank Account Created");
		System.out.println("Bank Id is " + ref8.bankId);
		System.out.println("Bank Name is " + ref8.bankName);
		System.out.println("Branch Name is " + ref8.branchName);
