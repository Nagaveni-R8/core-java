class SpotifyAccountCreation{
    ...
    public static boolean createSpotifyAccount(String userName, String pwd, String email, String confirmEmail, String dob, String sex){
		...
		isSpotifyAccountCreated = validatingSpotifyAccountUserDetails(userName, pwd, email, confirmEmail, dob, sex);
	...
	public static boolean validatingSpotifyAccountUserDetails(String userName, String pwd, String email, String confirmEmail, String dob, String sex){
	...
	public static void readSpotifyAccountDetails(){
		...
		System.out.println("The Spotify User Sex is :" + gender);
